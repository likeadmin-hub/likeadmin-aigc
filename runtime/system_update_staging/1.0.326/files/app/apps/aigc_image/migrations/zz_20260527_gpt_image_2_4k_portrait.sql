...
ON DUPLICATE KEY UPDATE `la_aigc_image_channel_spec`.`quality_label`=IF(`la_aigc_image_channel_spec`.`quality_label` IS NULL OR `la_aigc_image_channel_spec`.`quality_label` = '', VALUES(`quality_label`), `la_aigc_image_channel_spec`.`quality_label`),`la_aigc_image_channel_spec`.`width`=IF(`la_aigc_image_channel_spec`.`width` <= 0, VALUES(`width`), `la_aigc_image_channel_spec`.`width`),`la_aigc_image_channel_spec`.`height`=IF(`la_aigc_image_channel_spec`.`height` <= 0, VALUES(`height`), `la_aigc_image_channel_spec`.`height`),`la_aigc_image_channel_spec`.`platform_unit_cost`=IF(`la_aigc_image_channel_spec`.`platform_unit_cost` <= 0, VALUES(`platform_unit_cost`), `la_aigc_image_channel_spec`.`platform_unit_cost`),`la_aigc_image_channel_spec`.`tenant_unit_price`=IF(`la_aigc_image_channel_spec`.`tenant_unit_price` <= 0, VALUES(`tenant_unit_price`), `la_aigc_image_channel_spec`.`tenant_unit_price`),`la_aigc_image_channel_spec`.`provider_params_json`=IF(`la_aigc_image_channel_spec`.`provider_params_json` IS NULL OR `la_aigc_image_channel_spec`.`provider_params_json` = '' OR `la_aigc_image_channel_spec`.`provider_params_json` = '{}', VALUES(`provider_params_json`), `la_aigc_image_channel_spec`.`provider_params_json`),`la_aigc_image_channel_spec`.`status`=`la_aigc_image_channel_spec`.`status`,`la_aigc_image_channel_spec`.`sort`=IF(`la_aigc_image_channel_spec`.`sort` <= 0, VALUES(`sort`), `la_aigc_image_channel_spec`.`sort`),`la_aigc_image_channel_spec`.`update_time`=`la_aigc_image_channel_spec`.`update_time`;
