                                ...
                                <div class="content-form">
                                    ...
                                    <div class="form-box-item">
                                        ...
                                        <div style="display: flex; align-items: center; font-size: 12px; color: #666;">
                                            <input type="checkbox" name="clear_db" <?= $post['clear_db'] == 'on' ? 'checked' : '' ?>
                                                   style="width: auto; height: auto; padding-left: 0; margin-right: 8px;"/>
                                            清空当前数据库中同前缀的数据表后重新安装
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php if ($step == '5') { ?>
                                <div class="show" id="mounting-success">
                                    ...
                                    <div class="success-content">
                                        ...
                                        <div style="margin-top: 10px;font-size:14px;color: #444444">版本号：<?php echo htmlspecialchars($projectVersion, ENT_QUOTES, 'UTF-8'); ?></div>
                                        <div class="tips">
