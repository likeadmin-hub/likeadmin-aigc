...
INSERT INTO `la_system_menu` (`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
VALUES (117, 'C', '算力明细', 'el-icon-DataLine', 92, 'tenant.power_consume/lists', 'power-consume', 'tenant/power_consume/index', '', '', 0, 1, 0, '', 'core', 'core_tenant_power_consume_platform', 1, 1787184000, 1787184000);
INSERT INTO `la_system_menu` (`pid`, `type`, `name`, `icon`, `sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `app_code`, `source`, `source_menu_key`, `is_core`, `create_time`, `update_time`)
...
INSERT INTO `la_system_menu` (`pid`, `type`, `name`, `icon`, `sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `app_code`, `source`, `source_menu_key`, `is_core`, `create_time`, `update_time`)
VALUES (@core_power_mall_id, 'C', '算力市场', 'el-icon-Connection', 95, 'power.market/lists', 'market', 'power_mall/market', '', '', 0, 1, 0, '', 'core', 'core_power_market', 1, 1782604800, 1782604800);
SET @core_power_market_id := LAST_INSERT_ID();
INSERT INTO `la_system_menu` (`pid`, `type`, `name`, `icon`, `sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `app_code`, `source`, `source_menu_key`, `is_core`, `create_time`, `update_time`)
VALUES
(@core_power_market_id, 'A', '详情', '', 0, 'power.market/detail', '', '', '', '', 0, 0, 0, '', 'core', 'core_power_market_detail', 1, 1782604800, 1782604800),
...
(
    ...
    `domain_alias_enable` tinyint(10)                                                   NOT NULL DEFAULT 0 COMMENT '启用域名别名：0-启用；1-禁用',
    `access_mode`         varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL DEFAULT 'alias' COMMENT '访问方式:subdomain自动子域名,id租户ID,alias别名',
    `contract_package_id` int(10) UNSIGNED                                              NOT NULL DEFAULT 0 COMMENT '当前套餐ID',
    `contract_package_name` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '当前套餐名称',
    `contract_start_time` int(10) UNSIGNED                                              NOT NULL DEFAULT 0 COMMENT '合同开始时间',
    `contract_expire_time` int(10) UNSIGNED                                             NOT NULL DEFAULT 0 COMMENT '合同到期时间',
    `contract_renew_time` int(10) UNSIGNED                                              NOT NULL DEFAULT 0 COMMENT '最近续费时间',
    `contract_status`     tinyint(1) UNSIGNED                                           NOT NULL DEFAULT 0 COMMENT '合同状态 0未签约 1有效 2到期',
    `parent_tenant_id`    int(10) UNSIGNED                                              NOT NULL DEFAULT 0 COMMENT '父级租户ID',
    `source_tenant_id`    int(10) UNSIGNED                                              NOT NULL DEFAULT 0 COMMENT '来源租户ID',
    `create_time`         int(10)                                                       NOT NULL COMMENT '创建时间',
    `update_time`         int(10)                                                       NULL     DEFAULT NULL COMMENT '修改时间',
    `delete_time`         int(10)                                                       NULL     DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `la_tenant_system_menu` (`id`, `tenant_id`, `pid`, `type`, `name`, `icon`, `sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `create_time`, `update_time`)
VALUES (140, 0, 82, 'C', '微信配置', 'local-icon-notice_buyer', 70, 'channel.open_setting/getConfig',
...
INSERT INTO `la_tenant_system_menu` (`id`, `tenant_id`, `pid`, `type`, `name`, `icon`, `sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `app_code`, `source`, `source_menu_key`, `is_core`, `create_time`, `update_time`)
VALUES (9020, 0, 119, 'A', '修改密码', '', 1, 'user.user/resetPassword', '', '', '', '', 0, 1, 0, '', 'core', 'core_tenant_consumer_reset_password', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
INSERT INTO `la_tenant_system_menu` (`id`, `tenant_id`, `pid`, `type`, `name`, `icon`, `sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `create_time`, `update_time`)
...
VALUES (0, 0, 'M', '贴牌管理', 'el-icon-Connection', 650, '', 'brand', '', '', '', 0, 1, 0, '', 'core', 'core_tenant_brand', 1, 1782604800, 1782604800);
SET @core_tenant_brand_id := LAST_INSERT_ID();
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
VALUES
(0, @core_tenant_brand_id, 'C', '贴牌套餐', 'el-icon-PriceTag', 100, 'brand.package/lists', 'package', 'brand/package', '', '', 0, 1, 0, '', 'core', 'core_tenant_brand_package', 1, 1782604800, 1782604800),
(0, @core_tenant_brand_id, 'C', '额度购买', 'el-icon-ShoppingCart', 90, 'brand.quota/orders', 'quota', 'brand/quota', '', '', 0, 1, 0, '', 'core', 'core_tenant_brand_quota', 1, 1782604800, 1782604800),
(0, @core_tenant_brand_id, 'C', '订单管理', 'el-icon-Document', 80, 'brand.order/lists', 'order', 'brand/order', '', '', 0, 1, 0, '', 'core', 'core_tenant_brand_order', 1, 1782604800, 1782604800);
SET @core_tenant_brand_package_id := (
  SELECT `id` FROM `la_tenant_system_menu`
  WHERE `tenant_id` = 0 AND `source_menu_key` = 'core_tenant_brand_package'
  ORDER BY `id` DESC
  LIMIT 1
);
SET @core_tenant_brand_quota_id := (
  SELECT `id` FROM `la_tenant_system_menu`
  WHERE `tenant_id` = 0 AND `source_menu_key` = 'core_tenant_brand_quota'
  ORDER BY `id` DESC
  LIMIT 1
);
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
VALUES
(0, @core_tenant_brand_package_id, 'A', '保存定价', '', 0, 'brand.package/savePrice', '', '', '', '', 0, 0, 0, '', 'core', 'core_tenant_brand_package_save', 1, 1782604800, 1782604800),
(0, @core_tenant_brand_quota_id, 'A', '套餐列表', '', 0, 'brand.quota/packages', '', '', '', '', 0, 0, 0, '', 'core', 'core_tenant_brand_quota_packages', 1, 1782604800, 1782604800),
(0, @core_tenant_brand_quota_id, 'A', '创建订单', '', 0, 'brand.quota/createOrder', '', '', '', '', 0, 0, 0, '', 'core', 'core_tenant_brand_quota_create', 1, 1782604800, 1782604800),
(0, @core_tenant_brand_quota_id, 'A', '支付方式', '', 0, 'brand.pay/payWay', '', '', '', '', 0, 0, 0, '', 'core', 'core_tenant_brand_pay_way', 1, 1782604800, 1782604800),
(0, @core_tenant_brand_quota_id, 'A', '预支付', '', 0, 'brand.pay/prepay', '', '', '', '', 0, 0, 0, '', 'core', 'core_tenant_brand_pay_prepay', 1, 1782604800, 1782604800),
(0, @core_tenant_brand_quota_id, 'A', '支付状态', '', 0, 'brand.pay/payStatus', '', '', '', '', 0, 0, 0, '', 'core', 'core_tenant_brand_pay_status', 1, 1782604800, 1782604800);
INSERT INTO `la_tenant_system_menu` (`tenant_id`, `pid`, `type`, `name`, `icon`, `sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `app_code`, `source`, `source_menu_key`, `is_core`, `create_time`, `update_time`)
...
SET @core_tenant_power_market_id := (
  SELECT `id` FROM `la_tenant_system_menu`
  WHERE `tenant_id` = 0 AND `source_menu_key` = 'core_tenant_power_market'
  ORDER BY `id` DESC
  LIMIT 1
);
...
(0, @core_tenant_power_market_id, 'A', '模型列表', '', 0, 'power.market/models', '', '', '', '', 0, 0, 0, '', 'core', 'core_tenant_power_market_models', 1, 1782604800, 1782604800),
...
CREATE TABLE IF NOT EXISTS `la_power_market_product` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `product_code` varchar(191) NOT NULL DEFAULT '' COMMENT '商品编码',
  `resource_type` varchar(20) NOT NULL DEFAULT '' COMMENT '资源类型:model/app_api',
  `name` varchar(160) NOT NULL DEFAULT '' COMMENT '商品名称',
  `description` varchar(1000) NOT NULL DEFAULT '' COMMENT '商品说明',
  `source_code` varchar(40) NOT NULL DEFAULT '' COMMENT '来源标识',
  `upstream_resource_key` varchar(191) NOT NULL DEFAULT '' COMMENT '上游资源唯一键',
  `upstream_app_code` varchar(80) NOT NULL DEFAULT '' COMMENT '上游应用编码',
  `upstream_api_code` varchar(80) NOT NULL DEFAULT '' COMMENT '上游接口编码',
  `upstream_model_code` varchar(120) NOT NULL DEFAULT '' COMMENT '上游模型编码',
  `upstream_channel_code` varchar(120) NOT NULL DEFAULT '' COMMENT '上游渠道编码',
  `model_type` varchar(20) NOT NULL DEFAULT '' COMMENT '模型类型:text/image/video',
  `source_payload` text COMMENT '上游同步快照',
  `status` tinyint unsigned NOT NULL DEFAULT 1 COMMENT '状态:0下架 1上架',
  `create_time` int unsigned NOT NULL DEFAULT 0,
  `update_time` int unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_source_resource` (`source_code`,`upstream_resource_key`),
...
CREATE TABLE IF NOT EXISTS `la_power_market_sku` (
  ...
  `sku_key` varchar(160) NOT NULL DEFAULT '' COMMENT '上游SKU编码',
  `title` varchar(200) NOT NULL DEFAULT '' COMMENT '规格名称',
  `billing_mode` varchar(20) NOT NULL DEFAULT 'fixed' COMMENT '计费模式',
  `locked_params` text COMMENT '固定匹配参数',
  `selectable_params` text COMMENT '可选参数',
  `usage_unit` varchar(40) NOT NULL DEFAULT 'per_call' COMMENT '计费单位',
  `usage_unit_size` decimal(16,6) NOT NULL DEFAULT 1.000000 COMMENT '单位数量',
  `upstream_price` decimal(16,6) NOT NULL DEFAULT 0.000000 COMMENT '上游结算单价',
  `sale_points` decimal(16,6) NOT NULL DEFAULT 0.000000 COMMENT '平台销售单价',
  `sale_status` tinyint unsigned NOT NULL DEFAULT 1 COMMENT '销售状态:0停用 1启用',
  `price_hash` char(40) NOT NULL DEFAULT '' COMMENT '上游价格版本摘要',
  `source_payload` text COMMENT '上游SKU快照',
  `status` tinyint unsigned NOT NULL DEFAULT 1 COMMENT '状态:0下架 1上架',
  `sort` int NOT NULL DEFAULT 0,
  `create_time` int unsigned NOT NULL DEFAULT 0,
  `update_time` int unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `la_tenant_brand_quota_log` (
  ...
  `tenant_id` int unsigned NOT NULL DEFAULT 0,
  `package_id` int unsigned NOT NULL DEFAULT 0,
  `change_type` varchar(20) NOT NULL DEFAULT '' COMMENT 'increase/decrease/rollback',
...
CREATE TABLE IF NOT EXISTS `la_tenant_brand_package_price` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT 0 COMMENT '0下架 1上架',
  `create_time` int unsigned NOT NULL DEFAULT 0,
  `update_time` int unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_package` (`tenant_id`,`package_id`)
...
CREATE TABLE IF NOT EXISTS `la_decorate_template` (
  ...
  `published_pages` longtext COMMENT '正式页面结构',
  `published_history` longtext COMMENT '发布快照历史',
  `create_time` int unsigned NOT NULL DEFAULT 0,
  `update_time` int unsigned NOT NULL DEFAULT 0,
  `delete_time` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='template_id')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `template_id` int unsigned NOT NULL DEFAULT 0 COMMENT ''模板ID'' AFTER `tenant_id`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='terminal')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `terminal` varchar(20) NOT NULL DEFAULT ''mobile'' COMMENT ''终端 mobile/pc'' AFTER `template_id`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='channel')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `channel` varchar(20) NOT NULL DEFAULT ''common'' COMMENT ''渠道 common/h5/mp_weixin'' AFTER `terminal`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='page_code')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `page_code` varchar(64) NOT NULL DEFAULT '''' COMMENT ''页面标识'' AFTER `channel`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='page_type')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `page_type` varchar(30) NOT NULL DEFAULT ''custom'' COMMENT ''页面类型'' AFTER `page_code`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='route_path')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `route_path` varchar(255) NOT NULL DEFAULT '''' COMMENT ''页面路径'' AFTER `page_type`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='is_home')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `is_home` tinyint unsigned NOT NULL DEFAULT 0 COMMENT ''是否首页'' AFTER `route_path`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='is_system')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `is_system` tinyint unsigned NOT NULL DEFAULT 0 COMMENT ''是否系统页面'' AFTER `is_home`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='status')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `status` tinyint unsigned NOT NULL DEFAULT 1 COMMENT ''状态'' AFTER `is_system`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='sort')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `sort` int NOT NULL DEFAULT 0 COMMENT ''排序'' AFTER `status`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='draft_data')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `draft_data` longtext COMMENT ''草稿数据'' AFTER `meta`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='draft_meta')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `draft_meta` longtext COMMENT ''草稿页面设置'' AFTER `draft_data`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='published_data')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `published_data` longtext COMMENT ''发布数据'' AFTER `draft_meta`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='published_meta')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `published_meta` longtext COMMENT ''发布页面设置'' AFTER `published_data`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_page' AND COLUMN_NAME='draft_deleted')=0, 'ALTER TABLE `la_decorate_page` ADD COLUMN `draft_deleted` tinyint unsigned NOT NULL DEFAULT 0 COMMENT ''草稿待删除'' AFTER `published_meta`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_template' AND COLUMN_NAME='published_pages')=0, 'ALTER TABLE `la_decorate_template` ADD COLUMN `published_pages` longtext COMMENT ''正式页面结构'' AFTER `published_settings`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_decorate_template' AND COLUMN_NAME='published_history')=0, 'ALTER TABLE `la_decorate_template` ADD COLUMN `published_history` longtext COMMENT ''发布快照历史'' AFTER `published_pages`', 'SELECT 1'); PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
('aigc_llm','AIGC对话','resource/image/common/menu_generator.png','AIGC large model conversation application with multi-session, multi-turn context and SSE streaming.','aigc','','tenant,pc,uniapp',0,0,1,880,'1.1.4','installed',1778000000,1778000000)
...
('aigc_llm','1.1.4','>=1.0.0','local','{"code":"aigc_llm","name":"AIGC对话","version":"1.1.4","require_core":">=1.0.0","description":"AIGC large model conversation application with multi-session, multi-turn context and SSE streaming.","changelog":"1. 修复 AIGC 对话生成失败的问题。\n2. 提升多模态对话体验。\n3. 优化失败会话的恢复体验。","icon":"resource/image/common/menu_generator.png","category":"aigc","cover":"","is_builtin":1,"expire_policy":"allow","sort":880,"frontends":["tenant","pc","uniapp"],"api_prefix":"/app/aigc_llm","platform_menus":"menus/platform.json","menus":"menus/tenant.json","permissions":"permissions/tenant.json","migrations":"migrations","frontend_entries":[{"terminal":"tenant","entry_key":"aigc_llm_admin","name":"AIGC对话","path":"/app/aigc_llm","icon":"el-icon-ChatDotRound","sort":100,"status":1},{"terminal":"pc","entry_key":"aigc_llm","name":"AIGC对话","path":"/app/aigc_llm","icon":"resource/image/common/menu_generator.png","sort":100,"status":1},{"terminal":"uniapp","entry_key":"aigc_llm","name":"AIGC对话","path":"/apps/aigc_llm/pages/index/index","icon":"resource/image/common/menu_generator.png","sort":100,"status":1,"meta":{"pages":[{"name":"对话首页","path":"/apps/aigc_llm/pages/index/index"}]}}]}','1. 修复 AIGC 对话生成失败的问题。
2. 提升多模态对话体验。
3. 优化失败会话的恢复体验。',1,1778000000)
...
VALUES
(0,'system_default','1.0.0','paid','on','enabled',0,1778000000,1778000000),
...
(0,'aigc_style_transfer','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_photo_restore','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_model_wear','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_background_removal','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_image_translate','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_one_click_cleanup','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_product_suite','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_product_multi_angle','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_fashion_lookbook','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_product_promo_video','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_action_transfer','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_person_replacement','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_outpaint','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000),
(0,'aigc_local_redraw','1.0.0','paid','on','enabled',4102415999,1778000000,1778000000)
...
CREATE TABLE IF NOT EXISTS `la_aigc_llm_model` (
  ...
  `platform_input_unit_cost` decimal(12,4) NOT NULL DEFAULT 0.0000 COMMENT '平台输入成本，点/百万Token',
  `platform_output_unit_cost` decimal(12,4) NOT NULL DEFAULT 0.0000 COMMENT '平台输出成本，点/百万Token',
  `tenant_input_unit_price` decimal(12,4) NOT NULL DEFAULT 0.0000 COMMENT '用户输入售价，点/百万Token',
  `tenant_output_unit_price` decimal(12,4) NOT NULL DEFAULT 0.0000 COMMENT '用户输出售价，点/百万Token',
...
(9105,0,9104,'C','生图任务','el-icon-Picture',0,'app.aigc_image.admin_task/lists','task','apps/aigc_image/task','','',0,1,0,'aigc_image','app','aigc_image_task',0,1778000000,1778000000),
(9106,0,158,'C','案例广场','el-icon-PictureFilled',98,'case_gallery.case/lists','case-gallery','case_gallery/index','/case-gallery','',0,1,0,'system_default','core','core_tenant_case_gallery',1,1778000000,1778000000),
(9300,0,9106,'A','应用选项','',0,'case_gallery.case/apps','','','','',0,0,0,'system_default','core','core_tenant_case_gallery_apps',1,1778000000,1778000000),
(9301,0,9106,'A','详情','',0,'case_gallery.case/detail','','','','',0,0,0,'system_default','core','core_tenant_case_gallery_detail',1,1778000000,1778000000),
(9302,0,9106,'A','保存','',0,'case_gallery.case/save','','','','',0,0,0,'system_default','core','core_tenant_case_gallery_save',1,1778000000,1778000000),
(9303,0,9106,'A','任务加入','',0,'case_gallery.case/fromTask','','','','',0,0,0,'system_default','core','core_tenant_case_gallery_from_task',1,1778000000,1778000000),
(9304,0,9106,'A','修改状态','',0,'case_gallery.case/status','','','','',0,0,0,'system_default','core','core_tenant_case_gallery_status',1,1778000000,1778000000),
(9305,0,9106,'A','删除','',0,'case_gallery.case/delete','','','','',0,0,0,'system_default','core','core_tenant_case_gallery_delete',1,1778000000,1778000000),
(9307,0,158,'C','消息公告','el-icon-Bell',97,'notice.pc_notice/lists','notice','message/pc_notice/index','','',0,1,0,'system_default','core','core_tenant_pc_notice',1,1782691200,1782691200),
(9308,0,9307,'A','详情','',0,'notice.pc_notice/detail','','','','',0,0,0,'system_default','core','core_tenant_pc_notice_detail',1,1782691200,1782691200),
(9309,0,9307,'A','新增','',0,'notice.pc_notice/add','','','','',0,0,0,'system_default','core','core_tenant_pc_notice_add',1,1782691200,1782691200),
(9310,0,9307,'A','编辑','',0,'notice.pc_notice/edit','','','','',0,0,0,'system_default','core','core_tenant_pc_notice_edit',1,1782691200,1782691200),
(9311,0,9307,'A','删除','',0,'notice.pc_notice/delete','','','','',0,0,0,'system_default','core','core_tenant_pc_notice_delete',1,1782691200,1782691200),
(9312,0,9307,'A','状态','',0,'notice.pc_notice/status','','','','',0,0,0,'system_default','core','core_tenant_pc_notice_status',1,1782691200,1782691200),
...
(9114,0,9113,'C','视频任务','el-icon-VideoCamera',0,'app.aigc_video.admin_task/lists','task','apps/aigc_video/task','','',0,1,0,'aigc_video','app','aigc_video_task',0,1778000000,1778000000),
...
(9137,0,9136,'C','用量统计','',10,'app.aigc_canvas.admin/stat','stat','apps/aigc_canvas/stat','','',0,1,0,'aigc_canvas','app','aigc_canvas_stat',0,1778000000,1778000000),
(9139,0,9136,'C','创作任务','',20,'app.aigc_canvas.admin_run/lists','run','apps/aigc_canvas/run','','',0,1,0,'aigc_canvas','app','aigc_canvas_run',0,1778000000,1778000000);
...
(9156,0,9136,'C','基础配置','',30,'app.aigc_canvas.config/detail','config','apps/aigc_canvas/config','','',0,1,0,'aigc_canvas','app','aigc_canvas_config',0,1778000000,1778000000);

INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
VALUES
(0,9136,'C','Skills管理','',40,'app.aigc_canvas.skill/lists','skill','apps/aigc_canvas/skill','','',0,1,0,'aigc_canvas','app','aigc_canvas_skill',0,1778000000,1778000000),
(0,9136,'C','Agent 治理','',50,'app.aigc_canvas.governance/policies','governance','apps/aigc_canvas/governance','','',0,1,0,'aigc_canvas','app','aigc_canvas_governance',0,1778000000,1778000000),
(0,9136,'C','Agent Trace','',60,'app.aigc_canvas.admin_trace/lists','trace','apps/aigc_canvas/trace','','',0,1,0,'aigc_canvas','app','aigc_canvas_trace',0,1778000000,1778000000);
...
VALUES ('aigc_hairstyle','AI换发型','resource/image/common/menu_generator.png','面向人物发型和发色调整的 AI 图片创作应用，复用 AIGC 生图通道完成生成。','aigc','','tenant,pc',0,0,1,860,'1.0.4','installed','allow',1778000000,1778000000)
...
INSERT INTO `la_app_version` (`app_code`,`version`,`require_core`,`package_path`,`manifest_json`,`changelog`,`status`,`create_time`)
VALUES ('aigc_hairstyle','1.0.4','>=1.0.0','local','{"code":"aigc_hairstyle","name":"AI换发型","version":"1.0.4","require_core":">=1.0.0","description":"面向人物发型和发色调整的 AI 图片创作应用，复用 AIGC 生图通道完成生成。","changelog":"1. 恢复基础配置中的操作售价设置。\n2. 支持配置不同换发型操作类型售价。\n3. 优化基础配置入口与任务记录菜单。","icon":"resource/image/common/menu_generator.png","category":"aigc","cover":"","is_builtin":1,"expire_policy":"allow","sort":860,"frontends":["tenant","pc"],"api_prefix":"/app/aigc_hairstyle","platform_menus":"menus/platform.json","menus":"menus/tenant.json","permissions":"permissions/tenant.json","migrations":"migrations","frontend_entries":[{"terminal":"tenant","entry_key":"aigc_hairstyle_admin","name":"AI换发型","path":"/app/aigc_hairstyle","icon":"el-icon-MagicStick","sort":100,"status":1},{"terminal":"pc","entry_key":"aigc_hairstyle","name":"AI换发型","path":"/ai/tools/aigc_hairstyle","icon":"resource/image/common/menu_generator.png","sort":92,"status":1}],"dependencies":[{"app_code":"aigc_image","name":"AIGC生图","required_for":"图片生成"}]}','1. 恢复基础配置中的操作售价设置。
2. 支持配置不同换发型操作类型售价。
3. 优化基础配置入口与任务记录菜单。',1,1778000000)
ON DUPLICATE KEY UPDATE `require_core`=VALUES(`require_core`),`package_path`=VALUES(`package_path`),`manifest_json`=VALUES(`manifest_json`),`changelog`=VALUES(`changelog`),`status`=VALUES(`status`);
...
INSERT INTO `la_tenant_system_menu` (`id`,`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
VALUES
(9220,0,0,'M','AI换发型','el-icon-MagicStick',92,'','aigc-hairstyle','','','',0,1,0,'aigc_hairstyle','app','aigc_hairstyle',0,1778000000,1778000000),
(9221,0,9220,'C','基础配置','',20,'app.aigc_hairstyle.config/detail','config','apps/aigc_hairstyle/config','','',0,1,0,'aigc_hairstyle','app','aigc_hairstyle_config',0,1778000000,1778000000),
(9223,0,9220,'C','任务记录','',10,'app.aigc_hairstyle.task/lists','task','apps/aigc_hairstyle/task','','',0,1,0,'aigc_hairstyle','app','aigc_hairstyle_task',0,1778000000,1778000000)
...
DELETE FROM `la_app` WHERE `code`='aigc_action_transfer';
INSERT INTO `la_app` (`code`,`name`,`icon`,`description`,`category`,`cover`,`client_tags`,`install_count`,`view_count`,`is_builtin`,`sort`,`current_version`,`status`,`expire_policy`,`install_time`,`update_time`)
VALUES ('aigc_action_transfer','动作迁移','resource/image/common/menu_generator.png','上传参考人物图片和参考视频，将视频动作迁移到人物形象生成新视频。','aigc','','tenant,pc',0,0,0,846,'1.0.0','installed','allow',UNIX_TIMESTAMP(),UNIX_TIMESTAMP())
ON DUPLICATE KEY UPDATE `name`=VALUES(`name`),`icon`=VALUES(`icon`),`description`=VALUES(`description`),`category`=VALUES(`category`),`client_tags`=VALUES(`client_tags`),`is_builtin`=VALUES(`is_builtin`),`sort`=VALUES(`sort`),`current_version`=VALUES(`current_version`),`status`=VALUES(`status`),`expire_policy`=VALUES(`expire_policy`),`update_time`=VALUES(`update_time`);

DELETE FROM `la_app_version` WHERE `app_code`='aigc_action_transfer';
INSERT INTO `la_app_version` (`app_code`,`version`,`require_core`,`package_path`,`manifest_json`,`changelog`,`status`,`create_time`)
VALUES ('aigc_action_transfer','1.0.0','>=1.0.0','local','{"code":"aigc_action_transfer","name":"动作迁移","version":"1.0.0","require_core":">=1.0.0","description":"上传参考人物图片和参考视频，将视频动作迁移到人物形象生成新视频。","changelog":"1. 新增动作迁移工具。\\n2. 支持 PC 端上传人物图和参考视频生成动作迁移视频。\\n3. 支持租户配置模式售价和查看任务记录。","icon":"resource/image/common/menu_generator.png","category":"aigc","cover":"","is_builtin":0,"expire_policy":"allow","sort":846,"frontends":["tenant","pc"],"api_prefix":"/app/aigc_action_transfer","menus":"menus/tenant.json","permissions":"permissions/tenant.json","migrations":"migrations","frontend_entries":[{"terminal":"tenant","entry_key":"aigc_action_transfer_admin","name":"动作迁移","path":"/app/aigc_action_transfer","icon":"el-icon-VideoCamera","sort":90,"status":1},{"terminal":"pc","entry_key":"aigc_action_transfer","name":"动作迁移","path":"/ai/tools/aigc_action_transfer","icon":"resource/image/common/menu_generator.png","sort":82,"status":1}]}','1. 新增动作迁移工具。
2. 支持 PC 端上传人物图和参考视频生成动作迁移视频。
3. 支持租户配置模式售价和查看任务记录。',1,UNIX_TIMESTAMP());

DELETE FROM `la_app_frontend_entry` WHERE `app_code`='aigc_action_transfer';
INSERT INTO `la_app_frontend_entry` (`app_code`,`terminal`,`entry_key`,`name`,`path`,`icon`,`sort`,`status`,`meta`,`create_time`)
VALUES
('aigc_action_transfer','tenant','aigc_action_transfer_admin','动作迁移','/app/aigc_action_transfer','el-icon-VideoCamera',90,1,'{}',UNIX_TIMESTAMP()),
('aigc_action_transfer','pc','aigc_action_transfer','动作迁移','/ai/tools/aigc_action_transfer','resource/image/common/menu_generator.png',82,1,'{}',UNIX_TIMESTAMP());
...
DELETE FROM `la_app_api` WHERE `app_code`='aigc_action_transfer';
INSERT INTO `la_app_api` (`app_code`,`api_path`,`api_method`,`permission_key`,`scene`,`need_login`,`need_role_permission`,`status`,`create_time`,`update_time`)
VALUES
('aigc_action_transfer','app.aigc_action_transfer.config/detail','GET','aigc_action_transfer:config:detail','tenant_admin',1,1,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.config/setup','POST','aigc_action_transfer:config:setup','tenant_admin',1,1,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.task/lists','GET','aigc_action_transfer:task:lists','tenant_admin',1,1,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.task/detail','GET','aigc_action_transfer:task:detail','tenant_admin',1,1,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.task/retry','POST','aigc_action_transfer:task:retry','tenant_admin',1,1,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.task/delete','POST','aigc_action_transfer:task:delete','tenant_admin',1,1,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.config/detail','GET','aigc_action_transfer:config:user','user',0,0,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.generate/estimate','POST','aigc_action_transfer:generate:estimate','user',1,0,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.generate/index','POST','aigc_action_transfer:generate','user',1,0,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.task/lists','GET','aigc_action_transfer:task:lists:user','user',1,0,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.task/detail','GET','aigc_action_transfer:task:detail:user','user',1,0,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.task/delete','POST','aigc_action_transfer:task:delete:user','user',1,0,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
('aigc_action_transfer','app.aigc_action_transfer.result/delete','POST','aigc_action_transfer:result:delete:user','user',1,0,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP());

DELETE FROM `la_tenant_system_menu` WHERE `app_code`='aigc_action_transfer' AND `source`='app';
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT t.`id`,0,'M','动作迁移','el-icon-VideoCamera',82,'','aigc-action-transfer','','','',0,1,0,'aigc_action_transfer','app','aigc_action_transfer',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
FROM `la_tenant` t;
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT root.`tenant_id`,root.`id`,'C','基础配置','',40,'app.aigc_action_transfer.config/detail','config','apps/aigc_action_transfer/config','','',0,1,0,'aigc_action_transfer','app','aigc_action_transfer_config',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
FROM `la_tenant_system_menu` root WHERE root.`app_code`='aigc_action_transfer' AND root.`source_menu_key`='aigc_action_transfer';
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT root.`tenant_id`,root.`id`,'C','任务记录','',10,'app.aigc_action_transfer.task/lists','task','apps/aigc_action_transfer/task','','',0,1,0,'aigc_action_transfer','app','aigc_action_transfer_task',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
FROM `la_tenant_system_menu` root WHERE root.`app_code`='aigc_action_transfer' AND root.`source_menu_key`='aigc_action_transfer';
...
CREATE TABLE IF NOT EXISTS `la_aigc_short_drama_project` (
  ...
  `generation_settings_json` text COMMENT 'Project generation settings',
...
CREATE TABLE IF NOT EXISTS `la_aigc_short_drama_storyboard` (
  ...
  `recommended_duration_seconds` decimal(5,2) NOT NULL DEFAULT 5.00,
...
CREATE TABLE IF NOT EXISTS `la_ai_app_task` (
  `id` int unsigned NOT NULL AUTO_INCREMENT, `task_no` varchar(48) NOT NULL DEFAULT '', `tenant_id` int unsigned NOT NULL DEFAULT 0, `user_id` int unsigned NOT NULL DEFAULT 0,
  `app_code` varchar(80) NOT NULL DEFAULT '', `action_code` varchar(80) NOT NULL DEFAULT '', `business_table` varchar(100) NOT NULL DEFAULT '', `business_id` int unsigned NOT NULL DEFAULT 0, `parent_task_id` int unsigned NOT NULL DEFAULT 0,
  `status` varchar(30) NOT NULL DEFAULT 'queued', `progress` tinyint unsigned NOT NULL DEFAULT 0, `request_summary` text, `result_summary` text,
  `estimated_tenant_cost` decimal(16,6) NOT NULL DEFAULT 0.000000, `estimated_user_price` decimal(16,6) NOT NULL DEFAULT 0.000000, `actual_tenant_cost` decimal(16,6) NOT NULL DEFAULT 0.000000, `actual_user_price` decimal(16,6) NOT NULL DEFAULT 0.000000,
  `idempotency_key` varchar(64) NOT NULL DEFAULT '', `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, `finish_time` int unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`), UNIQUE KEY `uk_task_no` (`task_no`), UNIQUE KEY `uk_tenant_idempotency` (`tenant_id`,`idempotency_key`), KEY `idx_tenant_app_time` (`tenant_id`,`app_code`,`create_time`), KEY `idx_business` (`business_table`,`business_id`), KEY `idx_user_time` (`tenant_id`,`user_id`,`create_time`)
...
CREATE TABLE IF NOT EXISTS `la_ai_consumption_log` (
  `id` int unsigned NOT NULL AUTO_INCREMENT, `consume_no` varchar(48) NOT NULL DEFAULT '', `app_task_id` int unsigned NOT NULL DEFAULT 0, `tenant_id` int unsigned NOT NULL DEFAULT 0, `user_id` int unsigned NOT NULL DEFAULT 0,
  `app_code` varchar(80) NOT NULL DEFAULT '', `action_code` varchar(80) NOT NULL DEFAULT '', `resource_type` varchar(20) NOT NULL DEFAULT '', `product_id` int unsigned NOT NULL DEFAULT 0, `sku_id` int unsigned NOT NULL DEFAULT 0,
  `model_code` varchar(160) NOT NULL DEFAULT '', `api_code` varchar(120) NOT NULL DEFAULT '', `protocol` varchar(60) NOT NULL DEFAULT '', `provider` varchar(80) NOT NULL DEFAULT '', `upstream_request_id` varchar(160) NOT NULL DEFAULT '', `upstream_task_id` varchar(160) NOT NULL DEFAULT '',
  `quantity` decimal(16,6) NOT NULL DEFAULT 0.000000, `usage_unit` varchar(40) NOT NULL DEFAULT '', `usage_snapshot` text, `price_snapshot` text, `request_summary` text, `response_summary` longtext,
  `run_status` varchar(30) NOT NULL DEFAULT 'pending', `billing_status` varchar(30) NOT NULL DEFAULT 'none', `reserved_tenant_cost` decimal(16,6) NOT NULL DEFAULT 0.000000, `reserved_user_price` decimal(16,6) NOT NULL DEFAULT 0.000000, `actual_tenant_cost` decimal(16,6) NOT NULL DEFAULT 0.000000, `actual_user_price` decimal(16,6) NOT NULL DEFAULT 0.000000,
  `tenant_point_sn` varchar(64) NOT NULL DEFAULT '', `user_point_sn` varchar(64) NOT NULL DEFAULT '', `error_code` varchar(64) NOT NULL DEFAULT '', `error_message` varchar(1000) NOT NULL DEFAULT '', `refresh_requested_at` int unsigned NOT NULL DEFAULT 0, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, `finish_time` int unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`), UNIQUE KEY `uk_consume_no` (`consume_no`), KEY `idx_app_task` (`app_task_id`), KEY `idx_tenant_time` (`tenant_id`,`create_time`), KEY `idx_tenant_status` (`tenant_id`,`run_status`,`billing_status`), KEY `idx_upstream_task` (`upstream_task_id`), KEY `idx_product_sku` (`product_id`,`sku_id`)
...
CREATE TABLE IF NOT EXISTS `la_ai_task_operation` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT, `operation_no` varchar(40) NOT NULL DEFAULT '', `tenant_id` int unsigned NOT NULL DEFAULT 0, `admin_id` int unsigned NOT NULL DEFAULT 0, `terminal` varchar(20) NOT NULL DEFAULT '', `action` varchar(32) NOT NULL DEFAULT '', `reason` varchar(300) NOT NULL DEFAULT '', `total_count` int unsigned NOT NULL DEFAULT 0, `success_count` int unsigned NOT NULL DEFAULT 0, `failed_count` int unsigned NOT NULL DEFAULT 0, `skipped_count` int unsigned NOT NULL DEFAULT 0, `status` varchar(20) NOT NULL DEFAULT 'pending', `summary` text, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, `finish_time` int unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `la_ai_task_operation_item` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT, `operation_id` bigint unsigned NOT NULL DEFAULT 0, `tenant_id` int unsigned NOT NULL DEFAULT 0, `record_key` varchar(80) NOT NULL DEFAULT '', `record_type` varchar(20) NOT NULL DEFAULT '', `app_task_id` int unsigned NOT NULL DEFAULT 0, `consumption_id` int unsigned NOT NULL DEFAULT 0, `business_table` varchar(80) NOT NULL DEFAULT '', `business_id` int unsigned NOT NULL DEFAULT 0, `upstream_task_id` varchar(255) NOT NULL DEFAULT '', `action` varchar(32) NOT NULL DEFAULT '', `status` varchar(20) NOT NULL DEFAULT 'pending', `skip_reason` varchar(500) NOT NULL DEFAULT '', `before_status` varchar(32) NOT NULL DEFAULT '', `after_status` varchar(32) NOT NULL DEFAULT '', `before_billing_status` varchar(32) NOT NULL DEFAULT '', `after_billing_status` varchar(32) NOT NULL DEFAULT '', `before_snapshot` text, `after_snapshot` text, `result_message` varchar(1000) NOT NULL DEFAULT '', `job_key` varchar(120) NOT NULL DEFAULT '', `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, `finish_time` int unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `la_ai_task_delete_receipt` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT, `operation_id` bigint unsigned NOT NULL DEFAULT 0, `operation_item_id` bigint unsigned NOT NULL DEFAULT 0, `tenant_id` int unsigned NOT NULL DEFAULT 0, `admin_id` int unsigned NOT NULL DEFAULT 0, `record_key` varchar(80) NOT NULL DEFAULT '', `target_summary` text, `delete_summary` text, `create_time` int unsigned NOT NULL DEFAULT 0,
...
SET @install_task_log_platform_id := (SELECT `id` FROM `la_system_menu` WHERE `source_menu_key`='core_task_log_platform' LIMIT 1);
UPDATE `la_system_menu` SET `pid`=@install_task_log_platform_id,`name`='应用日志',`perms`='ai_task/lists',`paths`='application',`component`='tenant/task/index' WHERE `source_menu_key`='core_ai_task_platform';
INSERT INTO `la_system_menu` (`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT @install_task_log_platform_id,'C','应用日志','el-icon-List',100,'ai_task/lists','application','tenant/task/index','','',0,1,0,'','core','core_ai_task_platform',1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
WHERE @install_task_log_platform_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM `la_system_menu` WHERE `source_menu_key`='core_ai_task_platform');
INSERT INTO `la_system_menu` (`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT @install_task_log_platform_id,'C','消耗日志','el-icon-DataAnalysis',90,'ai_consumption/lists','consumption','power_mall/consumption','','',0,1,0,'','core','core_ai_consumption_platform',1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
WHERE @install_task_log_platform_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM `la_system_menu` WHERE `source_menu_key`='core_ai_consumption_platform');
UPDATE `la_system_menu` SET `pid`=@install_task_log_platform_id,`name`='消耗日志',`perms`='ai_consumption/lists',`paths`='consumption',`component`='power_mall/consumption' WHERE `source_menu_key`='core_ai_consumption_platform';
...
UPDATE `la_tenant_system_menu` SET `pid`=@install_tenant_task_log_id,`name`='生图列表',`icon`='el-icon-Picture',`sort`=90,`paths`='image',`update_time`=UNIX_TIMESTAMP() WHERE `tenant_id`=0 AND `source_menu_key`='aigc_image_task';
UPDATE `la_tenant_system_menu` SET `pid`=@install_tenant_task_log_id,`name`='视频列表',`icon`='el-icon-VideoCamera',`sort`=80,`paths`='video',`update_time`=UNIX_TIMESTAMP() WHERE `tenant_id`=0 AND `source_menu_key`='aigc_video_task';
...
SET @db_name = DATABASE();
SET @sql = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_aigc_canvas_agent_tool_call' AND COLUMN_NAME='delivery_item_id')=0,
...
SET @sql = IF((SELECT COUNT(*) FROM information_schema.STATISTICS WHERE TABLE_SCHEMA=@db_name AND TABLE_NAME='la_aigc_canvas_agent_tool_call' AND INDEX_NAME='idx_delivery_item')=0,
...
-- 微信开放平台接入（安装初始化；升级版本见 server/upgrade）
CREATE TABLE IF NOT EXISTS `la_wechat_open_platform` (`id` int unsigned NOT NULL, `app_id` varchar(64) NOT NULL DEFAULT '', `app_secret` text, `token` text, `encoding_aes_key` text, `callback_url` varchar(255) NOT NULL DEFAULT '', `developer_app_id` varchar(64) NOT NULL DEFAULT '', `developer_secret` text, `upload_private_key` text, `upload_certificate` text, `upload_private_pem` text, `component_verify_ticket` text, `ticket_expire_time` int unsigned NOT NULL DEFAULT 0, `component_access_token` text, `component_token_expire_time` int unsigned NOT NULL DEFAULT 0, `status` tinyint unsigned NOT NULL DEFAULT 1, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信开放平台配置';
CREATE TABLE IF NOT EXISTS `la_wechat_authorizers` (`id` int unsigned NOT NULL AUTO_INCREMENT, `tenant_id` int unsigned NOT NULL DEFAULT 0, `authorizer_appid` varchar(64) NOT NULL, `authorizer_type` varchar(20) NOT NULL DEFAULT '', `authorizer_name` varchar(120) NOT NULL DEFAULT '', `principal_name` varchar(160) NOT NULL DEFAULT '', `head_img` varchar(255) NOT NULL DEFAULT '', `original_id` varchar(128) NOT NULL DEFAULT '', `qrcode_url` varchar(500) NOT NULL DEFAULT '', `alias` varchar(120) NOT NULL DEFAULT '', `service_type` smallint NOT NULL DEFAULT 0, `verify_type` smallint NOT NULL DEFAULT 0, `business_info` longtext, `mini_program_info` longtext, `profile_json` longtext, `func_info` longtext, `authorizer_refresh_token_ciphertext` text, `access_token_ciphertext` text, `access_token_expire_time` int unsigned NOT NULL DEFAULT 0, `authorization_status` tinyint unsigned NOT NULL DEFAULT 1, `unbind_time` int unsigned NOT NULL DEFAULT 0, `last_sync_time` int unsigned NOT NULL DEFAULT 0, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`), UNIQUE KEY `uk_tenant_type_app` (`tenant_id`,`authorizer_type`,`authorizer_appid`), KEY `idx_appid` (`authorizer_appid`), KEY `idx_tenant_status` (`tenant_id`,`authorization_status`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信授权账号';
CREATE TABLE IF NOT EXISTS `la_wechat_credentials` (`id` int unsigned NOT NULL AUTO_INCREMENT, `tenant_id` int unsigned NOT NULL DEFAULT 0, `authorizer_id` varchar(64) NOT NULL DEFAULT '', `app_secret` text, `token` text, `encoding_aes_key` text, `api_key` text, `upload_private_key` text, `upload_certificate` text, `upload_private_pem` text, `upload_mode` varchar(20) NOT NULL DEFAULT 'key', `settings_json` longtext, `filing_json` longtext, `verify_status` tinyint unsigned NOT NULL DEFAULT 0, `last_verify_time` int unsigned NOT NULL DEFAULT 0, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`), UNIQUE KEY `uk_tenant` (`tenant_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信租户凭据';
CREATE TABLE IF NOT EXISTS `la_wechat_artifacts` (`id` int unsigned NOT NULL AUTO_INCREMENT, `version` varchar(40) NOT NULL, `artifact_dir` varchar(180) NOT NULL, `source_sha` varchar(64) NOT NULL DEFAULT '', `file_count` int unsigned NOT NULL DEFAULT 0, `sha256_manifest` longtext, `built_at` int unsigned NOT NULL DEFAULT 0, `verify_status` tinyint unsigned NOT NULL DEFAULT 0, `promoted` tinyint unsigned NOT NULL DEFAULT 0, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`), UNIQUE KEY `uk_version` (`version`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信小程序产物';
CREATE TABLE IF NOT EXISTS `la_wechat_templates` (`id` int unsigned NOT NULL AUTO_INCREMENT, `template_id` varchar(64) NOT NULL DEFAULT '', `draft_id` bigint unsigned NOT NULL DEFAULT 0, `template_version` varchar(40) NOT NULL DEFAULT '', `template_desc` varchar(255) NOT NULL DEFAULT '', `artifact_id` int unsigned NOT NULL DEFAULT 0, `upload_status` varchar(20) NOT NULL DEFAULT 'pending', `error_message` text, `upload_time` int unsigned NOT NULL DEFAULT 0, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`), KEY `idx_artifact` (`artifact_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信代码模板';
CREATE TABLE IF NOT EXISTS `la_wechat_template_drafts` (`id` int unsigned NOT NULL AUTO_INCREMENT, `artifact_id` int unsigned NOT NULL DEFAULT 0, `draft_id` bigint unsigned NOT NULL DEFAULT 0, `developer_app_id` varchar(64) NOT NULL DEFAULT '', `version` varchar(64) NOT NULL DEFAULT '', `description` varchar(255) NOT NULL DEFAULT '', `source_sha` varchar(64) NOT NULL DEFAULT '', `upload_status` varchar(20) NOT NULL DEFAULT 'pending', `output` text, `error_message` text, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`), KEY `idx_artifact_time` (`artifact_id`,`create_time`), KEY `idx_draft_id` (`draft_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信开放平台草稿上传记录';
CREATE TABLE IF NOT EXISTS `la_wechat_mnp_versions` (`id` int unsigned NOT NULL AUTO_INCREMENT, `tenant_id` int unsigned NOT NULL DEFAULT 0, `authorizer_id` int unsigned NOT NULL DEFAULT 0, `template_id` int unsigned NOT NULL DEFAULT 0, `version` varchar(40) NOT NULL, `description` varchar(255) NOT NULL DEFAULT '', `ext_json` longtext, `upload_mode` varchar(20) NOT NULL DEFAULT 'template', `upload_status` varchar(20) NOT NULL DEFAULT 'success', `upload_command` text, `runtime_config_hash` varchar(64) NOT NULL DEFAULT '', `api_base_url` varchar(255) NOT NULL DEFAULT '', `runtime_config_version` varchar(64) NOT NULL DEFAULT '', `experience_status` varchar(20) NOT NULL DEFAULT 'pending', `audit_status` varchar(20) NOT NULL DEFAULT 'none', `release_status` varchar(20) NOT NULL DEFAULT 'none', `rollback_from_id` int unsigned NOT NULL DEFAULT 0, `create_time` int unsigned NOT NULL DEFAULT 0, `update_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`), KEY `idx_tenant` (`tenant_id`,`create_time`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信小程序版本';
CREATE TABLE IF NOT EXISTS `la_wechat_mnp_reviews` (`id` int unsigned NOT NULL AUTO_INCREMENT, `version_id` int unsigned NOT NULL DEFAULT 0, `audit_no` varchar(80) NOT NULL DEFAULT '', `audit_status` varchar(20) NOT NULL DEFAULT '', `reason` text, `detail` text, `response_summary` text, `submit_time` int unsigned NOT NULL DEFAULT 0, `finish_time` int unsigned NOT NULL DEFAULT 0, `create_time` int unsigned NOT NULL DEFAULT 0, PRIMARY KEY (`id`), KEY `idx_version` (`version_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信小程序审核记录';
...
-- 微信开放平台菜单（安装初始化，一级开放平台，二级功能入口）。
SET NAMES utf8mb4;
SET @wechat_open_root_id := (SELECT `id` FROM `la_system_menu` WHERE `source_menu_key`='core_open_platform' AND `pid`=0 ORDER BY `id` LIMIT 1);
INSERT INTO `la_system_menu` (`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT 0,'M','开放平台','local-icon-weixin',500,'','open_platform','','','',0,1,0,'','core','core_open_platform',1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
WHERE @wechat_open_root_id IS NULL;
SET @wechat_open_root_id := (SELECT `id` FROM `la_system_menu` WHERE `source_menu_key`='core_open_platform' ORDER BY `id` DESC LIMIT 1);
INSERT INTO `la_system_menu` (`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT @wechat_open_root_id,'C',x.name,x.icon,x.sort,x.perms,x.path,x.component,'', '',0,1,0,'','core',x.key,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
FROM (SELECT '平台配置' name,'el-icon-Setting' icon,10 sort,'open_platform/config' perms,'config' path,'channel/open_platform/config' component,'core_open_platform_config' `key` UNION ALL SELECT '账号管理','el-icon-User',20,'open_platform/authorizers','authorizers','channel/open_platform/authorizers','core_open_platform_authorizers' UNION ALL SELECT '版本管理','el-icon-Connection',30,'open_platform/miniprogram','miniprogram','channel/open_platform/miniprogram','core_open_platform_miniprogram' `key` UNION ALL SELECT '调用日志','el-icon-Document',40,'open_platform/logs','logs','channel/open_platform/logs','core_open_platform_logs') x
WHERE @wechat_open_root_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM `la_system_menu` m WHERE m.`source_menu_key`=x.`key`);
UPDATE `la_system_menu` SET `name`='平台配置', `icon`='el-icon-Setting', `pid`=@wechat_open_root_id, `is_show`=1, `is_disable`=0 WHERE `source_menu_key`='core_open_platform_config';
UPDATE `la_system_menu` SET `name`='账号管理', `icon`='el-icon-User', `pid`=@wechat_open_root_id, `is_show`=1, `is_disable`=0 WHERE `source_menu_key`='core_open_platform_authorizers';
UPDATE `la_system_menu` SET `name`='版本管理', `icon`='el-icon-Connection', `pid`=@wechat_open_root_id, `is_show`=1, `is_disable`=0 WHERE `source_menu_key`='core_open_platform_miniprogram';
UPDATE `la_system_menu` SET `name`='调用日志', `icon`='el-icon-Document', `pid`=@wechat_open_root_id, `is_show`=1, `is_disable`=0 WHERE `source_menu_key`='core_open_platform_logs';

SET @wechat_open_tenant_channel_id := (SELECT `id` FROM `la_tenant_system_menu` WHERE (`source_menu_key`='core_tenant_channel_manage' OR `name`='渠道设置') AND `pid`=0 ORDER BY `id` LIMIT 1);
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT 0,@wechat_open_tenant_channel_id,'M','微信授权','local-icon-weixin',70,'','wechat_auth','','','',0,1,0,'','core','core_tenant_open_platform',1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
WHERE @wechat_open_tenant_channel_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM `la_tenant_system_menu` WHERE `source_menu_key`='core_tenant_open_platform');
SET @wechat_open_tenant_root_id := (SELECT `id` FROM `la_tenant_system_menu` WHERE `source_menu_key`='core_tenant_open_platform' ORDER BY `id` DESC LIMIT 1);
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT 0,@wechat_open_tenant_root_id,'C',x.name,'',x.sort,x.perms,x.path,'channel/open_platform/index','','',0,1,0,'','core',x.key,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
...
WHERE @wechat_open_tenant_root_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM `la_tenant_system_menu` m WHERE m.`source_menu_key`=x.`key`);
UPDATE `la_tenant_system_menu` SET `is_show`=0, `is_disable`=1, `update_time`=UNIX_TIMESTAMP()
WHERE `source_menu_key` IN ('core_tenant_open_platform_official','core_tenant_open_platform_mini','core_tenant_open_platform_authorizations') OR (`source_menu_key` LIKE 'core_tenant_open_%' AND `source_menu_key` NOT IN ('core_tenant_open_platform','core_tenant_open_platform_bind','core_tenant_open_platform_accounts'));
...
WHERE `tenant_id`=0 AND (`source_menu_key`='core_tenant_channel_manage' OR (`name`='渠道设置' AND `pid`=0))
...
WHERE `tenant_id`=0 AND `component` LIKE 'channel/%';
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
SELECT 0,@tenant_channel_overview_id,'C',x.`name`,'',x.`sort`,x.`perms`,x.`paths`,x.`component`,'channel/overview','',0,0,0,'','core',x.`key`,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
...
WHERE @tenant_channel_overview_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM `la_tenant_system_menu` menu WHERE menu.`tenant_id`=0 AND menu.`source_menu_key`=x.`key`);
UPDATE `la_tenant_system_menu` SET `is_show`=0, `is_disable`=0, `update_time`=UNIX_TIMESTAMP()
...
WHERE `tenant_id`=0 AND `component` IN (
...
WHERE parent.`tenant_id`=0 AND parent.`type`='C' AND parent.`paths`='lists' AND parent.`component`='consumer/lists/index'
  AND NOT EXISTS (SELECT 1 FROM `la_tenant_system_menu` existing_menu WHERE existing_menu.`tenant_id`=parent.`tenant_id` AND (existing_menu.`source_menu_key`='core_tenant_consumer_set_membership' OR existing_menu.`perms`='user.user/setMembership'));
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
...
AND parent.tenant_id=0 AND NOT EXISTS (SELECT 1 FROM `la_tenant_system_menu` existing WHERE existing.tenant_id=parent.tenant_id AND existing.app_code='aigc_short_drama' AND existing.source_menu_key='aigc_short_drama_agent');
