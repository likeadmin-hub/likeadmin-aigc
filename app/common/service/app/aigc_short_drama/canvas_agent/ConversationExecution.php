...
final class ConversationExecution
{
    ...
    public static function rejectInvalidResponse(int $tenant,int $user,int $runId,string $token,int $fence,string $diagnosticCode='UNSUPPORTED_MODEL_RESPONSE',string $diagnosticDetail=''): string
    {
        ...
        if (!in_array($diagnosticDetail,['intent_not_json','intent_shape','intent_value','intent_skill','intent_unexpected_output','intent_noncontinue','intent_continue_skill','intent_continue_reply','intent_continue_output','intent_stage_output','intent_consistency','post_settlement_projection'],true)) $diagnosticDetail='';
