...
final class ShortDramaBuiltinSkillCatalog
{
    ...
    private static function shortDramaWorkflowSkills(): array
    {
        $specs = [
            ...
            ['short_drama_script', '剧本创作', '把已确认的创作采集整理为可确认的故事设定、角色关系和分集剧情方案。', '创作采集完成后，用于短剧故事设定、角色弧光和分集大纲。', '基于冻结的创作采集输出故事梗概、角色关系、冲突、每集钩子和结局走向。当前工作流版本只把故事设定与大纲、当前单集剧本回填为可追溯的画布文本节点；分镜脚本留在剧本内容中，不单独生成画布节点。不得自行写入节点 ID 或任意画布 JSON。', ['剧本', '故事设定', '分集大纲', '角色弧光'], 980],
            ...
            ['short_drama_art_direction', '画风设计', '把剧情定位转换成可复用的色彩、光线、构图和镜头美术方向。', '需要确定短剧整体画风、时代质感或镜头基调时使用。', '输出统一的美术圣经：视觉类型、色板、光线、镜头语言、服装与场景质感，以及必须避免的风格漂移；确认后保存在对话工作流状态，供后续相关生图提示词使用，不单独创建画布文本节点。', ['画风', '美术', '色彩', '镜头风格'], 960],
