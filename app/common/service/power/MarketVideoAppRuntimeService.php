...
class MarketVideoAppRuntimeService
{
    ...
    public static function reserve(int $tenantId, int $userId, string $appCode, string $action, string $businessTable, string $businessTaskId, array $selection, array $request, array $billingOverride = []): array { return MarketVideoRuntimeService::reserve($tenantId, $userId, $appCode, $action, $businessTable, $businessTaskId, $selection + ['resource_type' => PowerMarketService::TYPE_APP_API], $request, $billingOverride); }
