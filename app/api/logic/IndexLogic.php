    ...
    public static function getDecorate($type)
    {
        if ((int)$type === 5) {
            return [
                'type' => 5,
                'name' => '系统风格',
                'data' => json_encode(DecorateTemplateService::activeMobileStyle((int)request()->tenantId), JSON_UNESCAPED_UNICODE),
                'meta' => '',
            ];
        }
        ...
        return DecorateTemplateService::activePublishedPage((int)request()->tenantId, $terminal, $pageCode, (int)$type, $channel, $preview, $templateId, $pageId);
    }
