...
class TaskController extends BaseApiController
{
    ...
    {
        return $this->success('获取成功', AigcProductPromoVideoService::taskLists(
    ...
    {
        try {
            return $this->success('获取成功', AigcProductPromoVideoService::taskDetail(
                (int)$this->request->tenantId,
    ...
    {
        try {
            AigcProductPromoVideoService::deleteTask(
                (int)$this->request->tenantId,
