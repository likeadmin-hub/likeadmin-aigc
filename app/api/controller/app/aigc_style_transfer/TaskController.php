...
class TaskController extends BaseApiController
{
    ...
    {
        return $this->success('获取成功', AigcStyleTransferService::taskLists(
    ...
    {
        try {
            return $this->success('获取成功', AigcStyleTransferService::taskDetail(
                (int)$this->request->tenantId,
    ...
    {
        try {
            AigcStyleTransferService::deleteTask(
                (int)$this->request->tenantId,
