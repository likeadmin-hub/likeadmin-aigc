...
class TaskController extends BaseApiController
{
    ...
    {
        return $this->success('获取成功', AigcPhotoRestoreService::taskLists(
    ...
    {
        try {
            return $this->success('获取成功', AigcPhotoRestoreService::taskDetail(
                (int)$this->request->tenantId,
    ...
    {
        try {
            AigcPhotoRestoreService::deleteTask(
                (int)$this->request->tenantId,
