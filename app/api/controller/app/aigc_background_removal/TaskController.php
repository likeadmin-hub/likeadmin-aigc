...
class TaskController extends BaseApiController
{
    ...
    {
        return $this->success('获取成功', AigcBackgroundRemovalService::taskLists(
    ...
    {
        try {
            return $this->success('获取成功', AigcBackgroundRemovalService::taskDetail(
                (int)$this->request->tenantId,
    ...
    {
        try {
            AigcBackgroundRemovalService::deleteTask(
                (int)$this->request->tenantId,
