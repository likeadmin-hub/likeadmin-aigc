...
class TaskController extends BaseApiController
{
    ...
    {
        return $this->success('获取成功', AigcProductSuiteService::taskLists(
    ...
    {
        try {
            return $this->success('获取成功', AigcProductSuiteService::taskDetail(
                (int)$this->request->tenantId,
    ...
    {
        try {
            AigcProductSuiteService::deleteTask(
                (int)$this->request->tenantId,
