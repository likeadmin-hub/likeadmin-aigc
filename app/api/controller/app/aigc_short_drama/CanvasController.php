...
{
    public function current() { try { return $this->success('success', ShortDramaCanvasService::current((int)$this->request->tenantId, $this->userId)); } catch (Exception $e) { return $this->fail($e->getMessage()); } }
