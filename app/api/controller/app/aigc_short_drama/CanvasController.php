...
class CanvasController extends BaseApiController
{
    ...
    public function previewShotWriteback() { try { return $this->success('success', \app\common\service\app\aigc_short_drama\ShortDramaCanvasWritebackService::previewShot((int)$this->request->tenantId, $this->userId, $this->request->post())); } catch (Exception $e) { return $this->fail($e->getMessage()); } }
    public function applyShotWriteback() { try { return $this->success('写回成功', \app\common\service\app\aigc_short_drama\ShortDramaCanvasWritebackService::applyShot((int)$this->request->tenantId, $this->userId, $this->request->post())); } catch (Exception $e) { return $this->fail($e->getMessage()); } }
