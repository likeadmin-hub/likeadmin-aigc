...
class TaskController extends BaseApiController
{
    ...
    {
        return $this->success('获取成功', AigcProductImageService::taskLists(
    ...
    {
        try {
            return $this->success('获取成功', AigcProductImageService::taskDetail(
                (int)$this->request->tenantId,
    ...
    {
        try {
            AigcProductImageService::deleteTask(
                (int)$this->request->tenantId,
