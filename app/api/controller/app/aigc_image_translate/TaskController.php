...
class TaskController extends BaseApiController
{
    ...
    {
        return $this->success('获取成功', AigcImageTranslateService::taskLists(
    ...
    {
        try {
            return $this->success('获取成功', AigcImageTranslateService::taskDetail(
                (int)$this->request->tenantId,
    ...
    {
        try {
            AigcImageTranslateService::deleteTask(
                (int)$this->request->tenantId,
