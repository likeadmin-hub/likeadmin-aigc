...
class SpecController extends BaseAdminController
{
    ...
    {
        try {
            AigcDigitalHumanChannelService::savePlatformSpec($this->request->post());
    ...
    {
        try {
            AigcDigitalHumanChannelService::deletePlatform($this->request->post() + ['type' => 'spec']);
    ...
    {
        try {
            AigcDigitalHumanChannelService::statusPlatform($this->request->post() + ['type' => 'spec']);
