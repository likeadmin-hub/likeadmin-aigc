...
(9333,{tenantId},9320,'C','背景音乐任务','',16,'app.aigc_short_drama.generation_task/lists','bgm-audio','apps/aigc_short_drama/bgm-audio','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_bgm_audio',0,1778000000,1778000000),
(9327,{tenantId},9320,'C','视频生成任务','',15,'app.aigc_short_drama.generation_task/lists','shot-video','apps/aigc_short_drama/shot-video','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_shot_video',0,1778000000,1778000000),
(9328,{tenantId},9320,'C','成片合成任务','',14,'app.aigc_short_drama.generation_task/lists','final-video','apps/aigc_short_drama/final-video','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_final_video',0,1778000000,1778000000),
