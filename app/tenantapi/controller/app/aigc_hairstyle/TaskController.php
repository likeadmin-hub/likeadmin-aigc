...
class TaskController extends BaseAdminController
{
    ...
    {
        try {
            return $this->success('获取成功', AigcHairstyleService::taskDetail(
                $this->tenantId,
    ...
    {
        try {
            return $this->success('重试成功', AigcHairstyleService::retryTask(
                $this->tenantId,
    ...
    {
        try {
            AigcHairstyleService::deleteTask($this->tenantId, (int)$this->request->post('id', 0));
