...
class AdminController extends BaseAdminController
{
    ...
    public function quota()
    {
        ...
        return $this->success('获取成功', AigcDigitalHumanService::quotaLists($this->tenantId));
    }
    ...
    public function sensitiveWord()
    {
        ...
        return $this->success('获取成功', AigcDigitalHumanService::sensitiveWordLists($this->tenantId));
    }
}
