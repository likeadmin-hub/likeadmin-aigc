...
CREATE TABLE IF NOT EXISTS `la_aigc_short_drama_script_task` (
  ...
  `skill_source` varchar(16) NOT NULL DEFAULT 'none',
...
-- Short-drama free canvas documents and task projection with isolated storage.
...
-- The current explicit formal target for an otherwise free short-drama canvas.
-- Historical canvas tasks/assets deliberately remain project_id=0 after binding.
...
-- Minimum, app-scoped safety audit. Raw prompts and replies are never stored.
