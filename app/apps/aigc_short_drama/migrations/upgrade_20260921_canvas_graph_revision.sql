-- Additive only. Execute through app installation/upgrade after explicit approval.
-- Existing JSON, tasks and assets are not rewritten; schema v1 remains readable.
