...
if (!preg_match('#^/api/app\.aigc_short_drama\.canvas_agent/(threads|createThread|messages|events|send|stop|run|stream)$#D',(string)$path)) {http_response_code(404);exit;}
