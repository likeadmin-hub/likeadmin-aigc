...
try {
    ...
    $node=['id'=>1,'type'=>'video','x'=>10,'y'=>20,'metadata'=>['video_url'=>'uploads/fixture/video.mp4','poster_url'=>'uploads/fixture/old.jpg','canvasRunId'=>123]];
    ...
    $run['id']=122;$project->invoke(null,$run,['url'=>'uploads/fixture/late-video.mp4','poster_url'=>'uploads/fixture/late.jpg']);
    $doc=Canvas::current(91001,92001,$id);
