...
class AigcMusicPricingDisplayContractTest extends TestCase
{
    public function testMusicPageRequestsTheAuthoritativeEstimateAfterLoadingConfig(): void
    {
        ...
        self::assertStringContainsString('ht=async()=>{Ve.value=await bg().catch(()=>({})),await B()}', $source);
    ...
    public function testMusicConfigDoesNotKeepAnOldPriceInTheClientCache(): void
    {
        ...
        self::assertStringContainsString('./asset-gallery-modal.e6854e80.js?v=20260819-musicpricefix', $page);
        self::assertStringContainsString('import("./_id_.57b448ac.js?v=20260819-musicpricefix")', $entry);
    }
