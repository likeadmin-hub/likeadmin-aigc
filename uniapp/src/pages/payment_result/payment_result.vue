            ...
            <view class="payment-result p-[20rpx]">
                ...
                <view class="mt-[40rpx]">
                    <view class="mb-[20rpx]">
                        ...
                        <u-button
                            v-else-if="pageOptions.from == 'membership'"
                            type="primary"
                            shape="circle"
                            hover-class="none"
                            @click="goOrder"
...
const amountText = computed(() => {
    const amount = orderInfo.order?.order_amount || '0.00'
    return pageOptions.value.from === 'membership' ? `¥${amount}` : `${amount} 点数`
})
...
const goOrder = () => {
    switch (pageOptions.value.from) {
        case 'recharge':
            ...
            break
        case 'membership':
            router.redirectTo('/packages/pages/membership/membership')
            break
    }
}
