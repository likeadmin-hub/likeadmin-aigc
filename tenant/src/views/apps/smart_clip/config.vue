...
<script lang="ts" setup name="tenant-smart-clip-config">
import { getSmartClipConfig, setSmartClipConfig } from '@/apps/smart_clip/api'
...
const getData = async () => {
    loading.value = true
    try {
        const data: any = await getSmartClipConfig()
