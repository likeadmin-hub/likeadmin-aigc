<template>
    <el-card class="!border-none" shadow="never">
        <div class="price-header">
            <div class="text-base font-medium">数字人视频调价</div>
        ...
        <el-form v-loading="pricingLoading" label-width="140px">
            ...
            <el-table :data="visibleGenerateModels" size="large" class="mb-6">
                ...
                <el-table-column label="用户售价" width="180">
                    <template #default="{ row }">
                        <el-input-number
                            ...
                            :min="Number(row.platform_unit_cost || 0)"
                            :precision="2"
                        />
                    </template>
                </el-table-column>
            ...
            <el-form-item label="形象克隆用户售价">
                <el-input-number
                    v-model="pricing.avatar_clone.tenant_unit_price"
                    :min="Number(pricing.avatar_clone.platform_unit_cost || 0)"
                    :precision="2"
                />
            </el-form-item>
            ...
            <el-form-item label="音色克隆用户售价">
                <el-input-number
                    v-model="pricing.voice_clone.tenant_unit_price"
                    :min="Number(pricing.voice_clone.platform_unit_cost || 0)"
                    :precision="2"
                />
            </el-form-item>
            <el-form-item>
...
const visibleGenerateModels = computed(() =>
    (pricing.generate_models || []).filter((row: any) => showDisabled.value || Number(row.status) === 1)
)
