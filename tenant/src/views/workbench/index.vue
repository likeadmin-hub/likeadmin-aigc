<template>
    <div class="workbench">
        <el-card class="!border-none dashboard-card mb-4" shadow="never">
            <template #header>
                <div class="flex items-center justify-between">
                    <span class="card-title">经营概览</span>
                    <span class="text-tx-secondary text-xs">本租户运营数据</span>
                </div>
            </template>
            <div class="dashboard-grid">
                <div class="dashboard-cell dashboard-cell--meta">
                    <div class="text-tx-secondary text-xs">系统名称</div>
                ...
                <div class="dashboard-cell dashboard-cell--meta">
                    ...
                    <div class="dashboard-channel">
                        <el-tag :type="interfaceChannel.configured ? 'success' : 'warning'">
                            {{ interfaceChannel.configured ? '平台已配置' : '平台未配置' }}
                        </el-tag>
                    </div>
                </div>
                <div class="dashboard-cell dashboard-cell--meta">
        ...
        <div class="chart-grid mb-4">
            ...
            <el-card class="!border-none" shadow="never">
                <template #header>
                    <span class="card-title">成本 / 用户收费趋势</span>
                </template>
        ...
        <div class="bottom-grid">
            <el-card class="!border-none" shadow="never">
                ...
                <el-table :data="workbenchData.app_stats" size="large">
                    ...
                    <el-table-column prop="tenant_cost_points" label="租户成本" min-width="110" />
...
const themeColor = ref<string>(settingStore.theme)
...
const pointTrendOption = computed(() => ({
    ...
    series: [
        { name: '租户成本', data: workbenchData.trend.tenant_cost_points, type: 'bar', barWidth: '34%' },
...
watch(
    ...
    (theme) => {
        ...
        textColor.value = isDark.value ? '#d6d8df' : '#606266'
        axisColor.value = isDark.value ? '#3f424c' : '#e5e7eb'
        updateCharts()
    }
)
