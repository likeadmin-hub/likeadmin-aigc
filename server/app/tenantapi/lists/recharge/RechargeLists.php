...
class RechargeLists extends BaseAdminDataLists implements ListsSearchInterface, ListsExcelInterface
{
    ...
    {
        $field = 'ro.id,ro.sn,ro.order_amount,ro.recharge_points,ro.package_name,ro.pay_way,ro.pay_time,ro.pay_status,ro.create_time,ro.refund_status';
        ...
        foreach ($lists as &$item) {
            ...
            $item['recharge_points'] = (float)($item['recharge_points'] ?? 0) > 0 ? $item['recharge_points'] : $item['order_amount'];
