...
class PublicVoiceController extends BaseAdminController
{
    ...
    {
        try {
            return $this->success('保存成功', AigcDigitalHumanService::savePublicVoice($this->tenantId, $this->request->post()), 1, 1);
        } catch (\Exception $e) {
    ...
    {
        try {
            AigcDigitalHumanService::deletePublicVoice($this->tenantId, (int)$this->request->post('id', 0));
