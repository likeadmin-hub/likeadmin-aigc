...
class ChannelController extends BaseAdminController
{
    ...
    {
        try {
            AigcImageChannelService::savePlatform($this->request->post());
    ...
    {
        try {
            AigcImageChannelService::deletePlatform($this->request->post());
    ...
    {
        try {
            AigcImageChannelService::statusPlatform($this->request->post());
