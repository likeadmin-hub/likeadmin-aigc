...
ON DUPLICATE KEY UPDATE `la_smart_clip_channel`.`name`=IF(`la_smart_clip_channel`.`name` IS NULL OR `la_smart_clip_channel`.`name` = '', VALUES(`name`), `la_smart_clip_channel`.`name`),`la_smart_clip_channel`.`provider`=IF(`la_smart_clip_channel`.`provider` IS NULL OR `la_smart_clip_channel`.`provider` = '', VALUES(`provider`), `la_smart_clip_channel`.`provider`),`la_smart_clip_channel`.`model`=IF(`la_smart_clip_channel`.`model` IS NULL OR `la_smart_clip_channel`.`model` = '', VALUES(`model`), `la_smart_clip_channel`.`model`),`la_smart_clip_channel`.`config_json`=IF(`la_smart_clip_channel`.`config_json` IS NULL OR `la_smart_clip_channel`.`config_json` = '' OR `la_smart_clip_channel`.`config_json` = '{}', VALUES(`config_json`), `la_smart_clip_channel`.`config_json`),`la_smart_clip_channel`.`status`=`la_smart_clip_channel`.`status`,`la_smart_clip_channel`.`sort`=IF(`la_smart_clip_channel`.`sort` <= 0, VALUES(`sort`), `la_smart_clip_channel`.`sort`),`la_smart_clip_channel`.`update_time`=`la_smart_clip_channel`.`update_time`;
...
ON DUPLICATE KEY UPDATE `la_smart_clip_channel_spec`.`quality_label`=IF(`la_smart_clip_channel_spec`.`quality_label` IS NULL OR `la_smart_clip_channel_spec`.`quality_label` = '', VALUES(`quality_label`), `la_smart_clip_channel_spec`.`quality_label`),`la_smart_clip_channel_spec`.`platform_unit_cost`=IF(`la_smart_clip_channel_spec`.`platform_unit_cost` <= 0, VALUES(`platform_unit_cost`), `la_smart_clip_channel_spec`.`platform_unit_cost`),`la_smart_clip_channel_spec`.`tenant_unit_price`=IF(`la_smart_clip_channel_spec`.`tenant_unit_price` <= 0, VALUES(`tenant_unit_price`), `la_smart_clip_channel_spec`.`tenant_unit_price`),`la_smart_clip_channel_spec`.`provider_params_json`=IF(`la_smart_clip_channel_spec`.`provider_params_json` IS NULL OR `la_smart_clip_channel_spec`.`provider_params_json` = '' OR `la_smart_clip_channel_spec`.`provider_params_json` = '{}', VALUES(`provider_params_json`), `la_smart_clip_channel_spec`.`provider_params_json`),`la_smart_clip_channel_spec`.`status`=`la_smart_clip_channel_spec`.`status`,`la_smart_clip_channel_spec`.`sort`=IF(`la_smart_clip_channel_spec`.`sort` <= 0, VALUES(`sort`), `la_smart_clip_channel_spec`.`sort`),`la_smart_clip_channel_spec`.`update_time`=`la_smart_clip_channel_spec`.`update_time`;
