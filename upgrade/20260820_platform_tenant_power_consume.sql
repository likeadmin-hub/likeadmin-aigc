...
SELECT @tenant_root_id,'C','算力明细','el-icon-DataLine',92,'tenant.power_consume/lists','power-consume','tenant/power_consume/index','','',0,1,0,'','core','core_tenant_power_consume_platform',1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
WHERE NOT EXISTS (
