...
JOIN `tmp_aigc_short_drama_style_seed` seed ON seed.`name` = target.`name`
SET target.`image` = seed.`image`, target.`update_time` = UNIX_TIMESTAMP()
WHERE target.`delete_time` = 0
  AND target.`image` LIKE 'uploads/images/20260707/style_library/%';
...
WHERE (`tenant_id`=0 AND `app_code`='aigc_short_drama' AND `source`='app')
   OR (`tenant_id`=0 AND `id` BETWEEN 9320 AND 9332);
...
VALUES
(0,0,'M','AI短剧','el-icon-VideoCamera',80,'','aigc-short-drama','','','',0,1,0,'aigc_short_drama','app','aigc_short_drama',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP());
SET @aigc_short_drama_menu_id := LAST_INSERT_ID();
INSERT INTO `la_tenant_system_menu` (`tenant_id`,`pid`,`type`,`name`,`icon`,`sort`,`perms`,`paths`,`component`,`selected`,`params`,`is_cache`,`is_show`,`is_disable`,`app_code`,`source`,`source_menu_key`,`is_core`,`create_time`,`update_time`)
VALUES
(0,@aigc_short_drama_menu_id,'C','AI短剧','',40,'app.aigc_short_drama.config/detail','','apps/aigc_short_drama/config','aigc-short-drama/config','',0,0,0,'aigc_short_drama','app','aigc_short_drama_index',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','基础配置','',30,'app.aigc_short_drama.config/detail','config','apps/aigc_short_drama/config','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_config',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','剧本列表','',20,'app.aigc_short_drama.script_task/lists','project','apps/aigc_short_drama/project','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_project',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','主体列表','',19,'app.aigc_short_drama.subject_task/lists','subject-task','apps/aigc_short_drama/subject-task','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_subject_task',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','场景列表','',18,'app.aigc_short_drama.scene_task/lists','scene-task','apps/aigc_short_drama/scene-task','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_scene_task',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','分镜列表','',17,'app.aigc_short_drama.storyboard/lists','storyboard','apps/aigc_short_drama/storyboard','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_storyboard',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','视频生成任务','',16,'app.aigc_short_drama.generation_task/lists','shot-video','apps/aigc_short_drama/shot-video','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_shot_video',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','成片合成任务','',15,'app.aigc_short_drama.generation_task/lists','final-video','apps/aigc_short_drama/final-video','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_final_video',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','灵感素材','',10,'app.aigc_short_drama.inspiration/lists','inspiration','apps/aigc_short_drama/inspiration','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_inspiration',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','主体库','',9,'app.aigc_short_drama.subject/lists','subject','apps/aigc_short_drama/subject','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_subject',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','画风库','',8,'app.aigc_short_drama.style/lists','style','apps/aigc_short_drama/style','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_style',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()),
(0,@aigc_short_drama_menu_id,'C','声音库','',7,'app.aigc_short_drama.public_voice/lists','public-voice','apps/aigc_short_drama/public-voice','','',0,1,0,'aigc_short_drama','app','aigc_short_drama_public_voice',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP());
