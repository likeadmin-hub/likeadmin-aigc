...
SELECT `id`,'aigc_fitting','1.0.1','paid','on','enabled',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP() FROM `la_tenant`
UNION ALL
SELECT 0,'aigc_fitting','1.0.1','paid','on','enabled',0,UNIX_TIMESTAMP(),UNIX_TIMESTAMP()
